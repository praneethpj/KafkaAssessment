package com.praneth.kafkaassessment1.config;
...
public class KafkaConsumerConfig {
    ...
    // +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    @Bean
    public ConsumerFactory<String, PaymentTransactionPayload> consumerFactory() {
       Map<String, Object> config = new HashMap<>();
        ...
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(), new JsonDeserializer<>(PaymentTransactionPayload.class));
    }

    @Bean
    public <T> ConcurrentKafkaListenerContainerFactory<?, ?> kafkaListenerJsonFactory() {
        ConcurrentKafkaListenerContainerFactory<String, PaymentTransactionPayload> factory = new ConcurrentKafkaListenerContainerFactory<>();
